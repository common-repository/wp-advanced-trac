<form method="POST" action="admin.php?page=wp-advanced-trac/projects&action=_create">
...
<table>
	...
	<tr>
		...
		<td><input type="text" name="project_home_url" /></td>
	</tr>
	<tr>
		<td>Project tracker url</td>
		<td><input type="text" name="project_issues_url" /></td>
	</tr>
	...
	<tr>
		...
		<td>
			...
			<input type="button" value="<?php esc_attr_e('Cancel'); ?>" name="newproject" id="newproject" onclick="window.location.href='admin.php?page=wp-advanced-trac/projects'" class="button-secondary action" />
		</td>
	</tr>
</table>

<?php 
$selected = $project->visible ? 'selected="selected"' : ''; 
...
?>
<form method="POST" action="admin.php?page=wp-advanced-trac/projects&action=_update">
...
<table>
	...
	<tr>
		<td>Project home url</td>
		<td><input type="text" name="project_home_url" value="<?php echo $project->project_home_url ?>" /></td>
	</tr>
	<tr>
		<td>Project tracker url</td>
		<td><input type="text" name="project_issues_url" value="<?php echo $project->project_issues_url ?>" /></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>
            ...
            <input type="button" value="<?php esc_attr_e('Cancel'); ?>" name="newproject" id="newproject" onclick="window.location.href='<?php echo $_SERVER['HTTP_REFERER'] ?>'" class="button-secondary action" />
		</td>
	</tr>
</table>
